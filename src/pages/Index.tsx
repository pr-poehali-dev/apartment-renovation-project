          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="animate-fade-in">
              ...
              <h1 className="text-5xl md:text-6xl font-serif font-bold mb-6 leading-tight">
                Ремонт квартир в Ростове-на-Дону<br />в современном стиле
              </h1>
          ...
          <div className="mt-12 text-center">
            ...
            <div className="flex justify-center gap-4">
              <a 
                ...
                className="w-12 h-12 bg-[#0077FF] hover:bg-[#0066DD] text-white rounded-full flex items-center justify-center transition-all duration-300 hover:scale-110"
                aria-label="Поделиться ВКонтакте"
              >
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M15.07 2H8.93C3.33 2 2 3.33 2 8.93v6.14C2 20.67 3.33 22 8.93 22h6.14c5.6 0 6.93-1.33 6.93-6.93V8.93C22 3.33 20.67 2 15.07 2zm3.23 14.46h-1.4c-.46 0-.6-.37-1.42-1.19-.72-.69-1.04-.78-1.22-.78-.25 0-.32.07-.32.41v1.08c0 .29-.09.46-1.07.46-1.57 0-3.31-.95-4.54-2.72-1.85-2.63-2.36-4.61-2.36-5.01 0-.18.07-.35.41-.35h1.4c.31 0 .42.14.54.47.61 1.73 1.63 3.25 2.05 3.25.16 0 .23-.07.23-.48v-1.87c-.05-.81-.48-.88-.48-1.16 0-.15.12-.29.32-.29h2.19c.26 0 .35.14.35.44v2.53c0 .26.11.35.19.35.16 0 .29-.09.57-.37 1.3-1.46 2.24-3.72 2.24-3.72.12-.26.26-.37.53-.37h1.4c.34 0 .42.17.34.44-.16.78-1.91 3.96-1.91 3.96-.13.22-.18.32 0 .57.13.18.55.54.83.87.51.51 1.07 1.16 1.2 1.54.12.38-.07.57-.45.57z"/>
                </svg>
              </a>
              <a 
                href={`https://t.me/share/url?url=${encodeURIComponent(window.location.href)}&text=${encodeURIComponent('Ремонт квартир в Ростове-на-Дону')}`}
                target="_blank"
                rel="noopener noreferrer"
                className="w-12 h-12 bg-[#0088cc] hover:bg-[#0077b5] text-white rounded-full flex items-center justify-center transition-all duration-300 hover:scale-110"
              ...
              <a 
                href={`https://api.whatsapp.com/send?text=${encodeURIComponent('Ремонт квартир в Ростове-на-Дону ' + window.location.href)}`}
                target="_blank"
                rel="noopener noreferrer"
                className="w-12 h-12 bg-[#25D366] hover:bg-[#20BA5A] text-white rounded-full flex items-center justify-center transition-all duration-300 hover:scale-110"
